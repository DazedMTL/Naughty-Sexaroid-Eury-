...
(function () {
  ...
  var pluginCommands = [
    ...
    [
      ...
      VAR,
      function (args) {
        _buyRate = getExtendRate(args[1], args[2]);
      },
    ],
    [
      "ショップ拡張設定",
      ...
      VAR,
      function (args) {
        _sellRate = getExtendRate(args[1], args[2]);
      },
    ],
  ];
  ...
  var _Window_ShopCommand_prototype_makeCommandList =
    Window_ShopBuy.prototype.makeCommandList;
  ...
  var _Window_ShopSell_prototype_isEnabled =
  ...
  var _Window_ShopSell_prototype_makeItemList =
    Window_ShopSell.prototype.makeItemList;
  ...
  var _Scene_Shop_prototype_createCommandWindow =
  ...
  var _Scene_Shop_prototype_createSellWindow =
    Scene_Shop.prototype.createSellWindow;
  ...
  var _Scene_Shop_prototype_onCategoryCancel =
    Scene_Shop.prototype.onCategoryCancel;
