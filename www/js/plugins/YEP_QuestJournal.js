 ...
 * Dark Plasma Word Wrap For Japanese を推奨します。
...
if (Utils.RPGMAKER_VERSION && Utils.RPGMAKER_VERSION >= "1.3.5") {
  ...
  Yanfly.Param.QuestCategoryWindow = JSON.parse(
    Yanfly.Parameters["Quest Category Window"]
  );
  Yanfly.Param.QuestListWindow = JSON.parse(
    Yanfly.Parameters["Quest List Window"]
  );
  Yanfly.Param.QuestTitleWindow = JSON.parse(
    Yanfly.Parameters["Quest Title Window"]
  );
  Yanfly.Param.QuestDataWindow = JSON.parse(
    Yanfly.Parameters["Quest Data Window"]
  );
  ...
  Yanfly.Quest.questRemove = JSON.parse(
    Yanfly.Quest.LunaticMode["Quest Remove"]
  );
  ...
  Yanfly.Quest.questSetCompleted = JSON.parse(
    Yanfly.Quest.LunaticMode["Quest Complete"]
  );
  ...
  Yanfly.Quest.questSetFailed = JSON.parse(
    Yanfly.Quest.LunaticMode["Quest Fail"]
  );
  ...
  Yanfly.Quest.questSetAvailable = JSON.parse(
    Yanfly.Quest.LunaticMode["Quest Available"]
  );
  ...
  Yanfly.Quest.questChangeDescriptionIndex = JSON.parse(
    Yanfly.Quest.LunaticMode["Change Description"]
  );
  ...
  Yanfly.Quest.questObjectivesShow = JSON.parse(
    Yanfly.Quest.LunaticMode["Show Objective"]
  );
  ...
  Yanfly.Quest.questObjectivesHide = JSON.parse(
    Yanfly.Quest.LunaticMode["Hide Objective"]
  );
  ...
  Yanfly.Quest.questObjectivesNormal = JSON.parse(
    Yanfly.Quest.LunaticMode["Normalize Objective"]
  );
  ...
  Yanfly.Quest.questObjectivesComplete = JSON.parse(
    Yanfly.Quest.LunaticMode["Complete Objective"]
  );
  ...
  Yanfly.Quest.questObjectivesFail = JSON.parse(
    Yanfly.Quest.LunaticMode["Fail Objective"]
  );
  ...
  Yanfly.Quest.questRewardsShow = JSON.parse(
    Yanfly.Quest.LunaticMode["Show Reward"]
  );
  ...
  Yanfly.Quest.questRewardsHide = JSON.parse(
    Yanfly.Quest.LunaticMode["Hide Reward"]
  );
  ...
  Yanfly.Quest.questRewardsNormal = JSON.parse(
    Yanfly.Quest.LunaticMode["Normalize Reward"]
  );
  ...
  Yanfly.Quest.questRewardsClaim = JSON.parse(
    Yanfly.Quest.LunaticMode["Claim Reward"]
  );
  ...
  Yanfly.Quest.questRewardsDeny = JSON.parse(
    Yanfly.Quest.LunaticMode["Deny Reward"]
  );
  ...
  Yanfly.Quest.questChangeSubtextIndexEval = JSON.parse(
    Yanfly.Quest.LunaticMode["Change Subtext"]
  );
  ...
  Window_QuestData._questNoDataFmt = JSON.parse(
    Yanfly.Param.QuestDataWindow["No Data Text"] || ""
  );
  ...
  Window_QuestList.prototype.initialize = function (cw, dw, tw) {
    this._currentCategory = JSON.parse(
      Yanfly.Param.QuestCategoryWindow["Category Order"]
    )[0];
  ...
  Yanfly.Quest.createBefore = JSON.parse(
    Yanfly.Quest.LunaticMode["Before Create Windows"]
  );
  Yanfly.Quest.createAfter = JSON.parse(
    Yanfly.Quest.LunaticMode["After Create Windows"]
  );
  Yanfly.Quest.terminateMenu = JSON.parse(
    Yanfly.Quest.LunaticMode["Close Quest Menu"]
  );
