...
(function () {
  ...
  if (!Galv.aliased) {
    Galv.MSE.Game_Interpreter_pluginCommand =
  ...
  Galv.MSE.delay = Number(
    PluginManager.parameters("GALV_MessageSoundEffects")["Delay Time"]
  );
  Galv.MSE.defaultSe = Galv.MSE.makeSound(
    PluginManager.parameters("GALV_MessageSoundEffects")["Default Talk SE"]
  );
  Galv.MSE.defaultConfirmSe = Galv.MSE.makeSound(
    PluginManager.parameters("GALV_MessageSoundEffects")["Default Confirm SE"]
  );

  Galv.MSE.quickSE = [];
  for (var i = 1; i < 5; i++) {
    var name = "Quick SE " + i;
    Galv.MSE.quickSE[i] = Galv.MSE.makeSound(
      PluginManager.parameters("GALV_MessageSoundEffects")[name]
    );
  }
  ...
  Galv.MSE.Window_Message_updateMessage =
  ...
  Galv.MSE.Window_Message_terminateMessage =
