...
/*:
 * ==============================================================================
 * @plugindesc v18.1 SA Core Speed Improvement (Define at the top)
 * @author seea
...
(function () {
  ...
  const paramMinCacheCWCHoldingCount = Number(
    params["Minimum CWC-cache holding count"] || 15
  );
  ...
  if (LINFO) {
    ...
    console.log(
      "paramMinCacheCWCHoldingCount = " + paramMinCacheCWCHoldingCount
    );
  }
